...
| Property lifecycle | `GET/POST/PUT /api/properties` | `PropertyAppService`, property validators | `PropertiesPage.tsx`, `PropertyDetailPage.tsx` | `PropertyValidatorTests` | `PropertiesEndpointsTests` | TBD | Status transition coverage | TBD | In Progress |
